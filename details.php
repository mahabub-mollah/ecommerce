                      ...
                      while ($row_products=mysqli_fetch_array($run_products)) {
                        ...
                        $pro_image1=$row_products['product_img1'];
                         ...
                         echo"
                           ...
                           <h3>$pro_title</h3>
                           <img src='admin_area/product_images/".trim($pro_image1)."' width='180' height='180' />
                            <img src='admin_area/product_images/".trim($pro_image2)."' width='250' height='250' />
                             <img src='admin_area/product_images/".trim($pro_image3)."' width='250' height='280' />
                             <p><b> Price: $ $pro_price</B></p>
                           
                               <p><b>$pro_des</B></p>
                           <a href='index.php?pro_id=$pro_id' style='float:left;'>GoBack</a>
